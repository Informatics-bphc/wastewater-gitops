...
vb_sparkline2 <- value_box(
  title = "Citywide Levels and Trends",
  value = img(src = here("docs","img", "circ_high_stable.png"), height = "38", width = "38"),
  h4("Level: High"),
  p("XX copies/mL"),
  h4("2-week Trend: Stable"),
...
navset_card_tab(
  ...
  nav_panel(
    ...
    #  height = 300,
      ...
      vb_sparkline2,
      #card(fullscreen = TRUE,  vb_sparkline2),
